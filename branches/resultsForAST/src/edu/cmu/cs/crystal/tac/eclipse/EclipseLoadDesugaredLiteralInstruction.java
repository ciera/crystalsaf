 ...
 *
 */
class EclipseLoadDesugaredLiteralInstruction extends
	 ...
	 * @param tac
	 */
	public EclipseLoadDesugaredLiteralInstruction(Expression node,
			Object literal, IEclipseVariableQuery tac) {
